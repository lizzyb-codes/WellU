...
const Affirmations: React.FC = () => {
  ...
  const handleRandomAffirmation = () => {
    ...
    if (filtered.length > 0) {
      ...
      window.setTimeout(() => {
        ...
        window.setTimeout(() => setIsRandomizing(false), 240);
      }, 210);
    }
  };
  ...
  const handleCopyAffirmation = (text: string) => {
    ...
    confetti({ particleCount: 35, spread: 40, origin: { y: 0.75 }, colors: ['#F9A8D4', '#A3E635', '#FDE68A'] });
    setCopied(true);
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="lg:col-span-2 space-y-6">
                ...
                {currentAffirmation && (
                  <div className={`relative z-10 bg-linear-to-br from-green-50 to-yellow-50 rounded-2xl shadow-sm p-8 border border-green-100 ${isRandomizing ? 'affirmation-randomizing' : ''}`}>
                    ...
                    <p className="font-quote text-3xl italic text-gray-800 leading-relaxed text-center mb-6 sm:text-4xl">
                      ...
                      >
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            ...
                            <p className="font-quote text-xl italic text-gray-800 leading-relaxed">{affirmation.text}</p>
                          </div>
